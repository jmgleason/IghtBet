...
const BetDetailScreen = props => {
  ...
  const bet = useSelector((state) => state.bets.allBets.find((bet) => bet.id == betId));
      ...
      <View style={styles.mainView}>
        <View style={styles.detailSection}>
          ...
          <View style={styles.labelSection}>
            ...
            <Text style={styles.labelText}>{currencyHelper.penniesToFormattedDollars(bet.wager)}</Text>
          </View>

          <View style={styles.labelSection}>
            <Text style={styles.labelText}>Expires:</Text>
            <Text style={styles.labelText}>{dateTimeHelper.getStandardDate(new Date(bet.expirationDate))}</Text>
          </View>
        </View>
